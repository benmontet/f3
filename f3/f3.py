...
class f3(object):
    ...
    def __init__(self, kic, ffi_dir=None):
        ...
        self.times, self.qs, self.year = np.loadtxt('obs_info.txt', unpack=True)
    ...
    def find_other_sources(self, plot_flag = False, edge_lim = 0.015, min_val = 5000, 
        ...
        if plot_flag == True:
            ...
            plt.imshow((np.ceil(targets/100.0)*self.integrated_postcard+np.ceil(targets/100.0)*3500000), 
